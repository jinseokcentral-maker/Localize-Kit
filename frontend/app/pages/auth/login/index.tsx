    ...
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="text-center mb-8">
        <a href="/" className="inline-flex items-center gap-2">
          <span className="text-2xl font-bold">LocalizeKit</span>
        </a>
      </div>
      ...
      <div className="bg-card border border-border rounded-lg p-8">
        <div className="text-center mb-8">
          <TypoH1 className="text-2xl">Welcome back</TypoH1>
          <TypoP muted className="mt-2">
            Sign in to your account to continue
          </TypoP>
        </div>

        {/* Google OAuth Button */}
        <button className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-border rounded-md hover:bg-accent transition-colors">
